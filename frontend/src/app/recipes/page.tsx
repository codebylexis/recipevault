    ...
    <div className="max-w-6xl mx-auto p-6">
      ...
      {recipes.length === 0 ? (
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {recipes.map(recipe => (
            <div key={recipe.id} className="border rounded overflow-hidden hover:shadow transition">
              {recipe.imageUrl && (
                <img
              ...
              <div className="p-4 space-y-1">
                ...
                <Link href={`/recipes/${recipe.id}`} className="text-blue-600 text-sm underline">
                  View Recipe
                </Link>
              </div>
            </div>
